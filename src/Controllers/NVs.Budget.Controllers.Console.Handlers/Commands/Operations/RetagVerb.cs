...
internal class RetagVerbHandler(IMediator mediator, CriteriaParser parser, IResultWriter<Result> writer) : CriteriaBasedVerbHandler<RetagVerb, TrackedOperation>(parser, writer)
{
