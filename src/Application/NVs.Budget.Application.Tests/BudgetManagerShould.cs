...
public class BudgetManagerShould
{
    ...
    public async Task RenameOwnedAccounts()
    {
        ...
        var expected = new TrackedBudget(getOwnedBudgets[0].Id, getOwnedBudgets[0].Name, getOwnedBudgets[0].Owners, getOwnedBudgets[0].TaggingRules)
        {
    ...
    public async Task RemoveAccountOwnedOnlyByCurrentOwner()
    {
        ...
        var expected = new TrackedBudget(budgets[0].Id, budgets[0].Name, budgets[0].Owners, budgets[0].TaggingRules)
        {
